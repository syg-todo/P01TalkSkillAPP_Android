...
public class RegisterBiz {
    ...
    public RegisterBiz(OnRequestListener listener,Context context) {
    ...
    public void requestUserRegister(int tag,String mobile,String password,String yzcode){
        Map<String,String> params = new HashMap<>();
        params.put("mobile",mobile);
        params.put("password",password);
        params.put("yzcode",yzcode);
        OkNetUtils.post(tag, Constants.URL.BASE_URL+Constants.URL.USER_REGISTER_URL,params,context,listener);
    ...
    public void requestRegisterMessageUrl(int tag){
        Map<String,String> params = new HashMap<>();
        OkNetUtils.get(tag,Constants.URL.BASE_URL+Constants.URL.REGISTER_MESSAGE_URL,params,context,listener);
