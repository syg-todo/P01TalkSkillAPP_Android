package com.tuodanhuashu.app.widget.player.view.tips;
...
import com.tuodanhuashu.app.widget.player.ITheme;
...
public class ErrorView extends RelativeLayout implements ITheme {
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.video_player_dialog_error, null);
     ...
     */
    @Override
    public void setTheme(VideoPlayerView.Theme theme) {
//        if(theme == VideoPlayerView.Theme.Blue){
...
//        }else if(theme == VideoPlayerView.Theme.Green){
...
//        }else if(theme == VideoPlayerView.Theme.Orange){
...
//        }else if(theme == VideoPlayerView.Theme.Red){
